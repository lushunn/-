...
import numpy as np
####改变数据类型
test_behavior_A=test_behavior_A[['ccx_id','var1','var3','var4','var5','var6','var160','var163']]
train_behavior_A=train_behavior_A[['ccx_id','var1','var3','var4','var5','var6','var160','var163']]
test_behavior_B=test_behavior_B[['ccx_id','var1','var3','var4','var5','var6','var160','var163']]
...
'''
pred_final=(0.8*pred_lgm+0.2*pred_xgb)
pred_final_B=(pred_lgm_B+pred_xgb_B)/2
